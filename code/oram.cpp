...
// these vectors stores the path from the root to leaf...
...
tnode *root =NULL;  // initialisation of the root for the main tree...
rectnode *recroot =NULL; // // initialisation of the recroot for the recursive tree... 
...
int main()
{
	...
	proper_insert(root);
	cout<<"Printing tree in preorder"<<endl;
	preOrder(root);
